		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Book app",
									"targetURL": "#beapsapbookapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beapsapbookapp-display": {
								"semanticObject": "beapsapbookapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.ap.sap.bookapp",
									"url": sap.ui.require.toUrl("be/ap/sap/bookapp")
								}
							}
						}
					}
